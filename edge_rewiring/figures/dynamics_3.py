...
"""
legend_elements = [
    Patch(facecolor=S, label='does not have information'),
    Patch(facecolor=I, label='has information'),
]
plt.legend(handles=legend_elements, title="Information State", loc="upper right")
"""
