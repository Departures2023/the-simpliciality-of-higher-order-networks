...
if __name__ == "__main__":
    # File path
    file_path = r'C:\Users\AnnaSennpai\Desktop\Grinnell\Second Year Summer\MAP\the-simpliciality-of-higher-order-networks\experiment_result\model_generation_es\cumulative_data.txt'
